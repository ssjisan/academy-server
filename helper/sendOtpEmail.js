...
const sendOtpEmail = async (email, otp) => {
  const logoUrl =
    "https://res.cloudinary.com/dmyttqosa/image/upload/v1740032138/rikadobrburiekxh4rcs.png"; // Replace with your actual logo URL
                                                        ...
                                                        <tbody>
                                                          <tr>
                                                            ...
                                                            >
                                                              <img
                                                                alt="Logo"
                                                                src="https://res.cloudinary.com/dmyttqosa/image/upload/v1740032138/rikadobrburiekxh4rcs.png"
                                                                style="
                                                                  border: 0;
                                                                  display: block;
                                                                  outline: none;
